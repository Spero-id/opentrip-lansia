                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10 items-start">
                    ...
                    <div className="w-full lg:col-span-5 bg-gray-50 rounded-3xl p-8 sm:p-10 text-center">
                        ...
                        <a
                            ...
                            className="w-full flex items-center p-1 justify-center gap-2 bg-[#25D366] text-white py-1 rounded-xl font-semibold hover:bg-[#25c15e]/80 transition-colors"
                        >
                            <img className="rounded-full p-1 border-border" src="/whatsapp-logo.webp" alt="whatsapp" width={50} height={50} />
