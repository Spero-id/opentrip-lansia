                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10 items-start">
                    ...
                    <div className="w-full lg:col-span-5 bg-gray-50 rounded-3xl p-8 sm:p-10 text-center">
                        ...
                        <a
                            ...
                            className="w-full flex items-center p-1 justify-center gap-2 bg-[#25c15e] text-white py-2 rounded-xl font-semibold hover:bg-[#25c15e]/80 transition-colors"
                        >
                            <img className="bg-white rounded-full p-1 border-border" src="/whatsapp-logo.png" alt="whatsapp" width={40} height={40} />
