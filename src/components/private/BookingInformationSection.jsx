...
function validatePeserta(val) {
  ...
  if (num < 1) return "Jumlah peserta minimal 1 orang";
  return null;
}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <Field label="Nama Pemesan" required error={errors.nama}>
          <div className="relative">
            ...
            <input type="text" placeholder="Contoh: John Doe" value={form.nama}
        ...
        <Field label="Nomor Ponsel" required error={errors.phone}>
          <div className="relative">
            ...
            <input type="tel" placeholder="Contoh: 081xxxxxxxxx" value={form.phone}
              onChange={e => set("phone", e.target.value)}
              className={inputCls(errors.phone, "pl-9")} />
          </div>
        </Field>

        <Field label="Email" required hint="Konfirmasi akan dikirim ke email ini" error={errors.email}>
          <div className="relative">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
            ...
            <input type="email" placeholder="Contoh: xxxx@xxxxx.xxx" value={form.email}
