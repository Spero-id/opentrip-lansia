...
async function seed() {
  ...
  const dests = await db.insert(destinations).values([
    { name: "Candi Borobudur", slug: "candi-borobudur", description: "Candi Buddha terbesar di dunia, akses kursi roda tersedia.", categoryId: katBudaya.id, difficultyLevel: "mudah", isActive: true, visitEstimateMinutes: 180, accessibilityInfo: "Tersedia jalur kursi roda, area istirahat setiap 100m" },
    { name: "Pantai Parangtritis", slug: "pantai-parangtritis", description: "Pantai pasir hitam yang legendaris. Medan landai cocok untuk lansia.", categoryId: katAlam.id, difficultyLevel: "mudah", isActive: true, visitEstimateMinutes: 120, accessibilityInfo: "Area parkir dekat, jalur pejalan kaki rata" },
    { name: "Malioboro", slug: "malioboro", description: "Kawasan perbelanjaan dan kuliner ikonik Yogyakarta.", categoryId: katKuliner.id, difficultyLevel: "mudah", isActive: true, visitEstimateMinutes: 150 },
    { name: "Masjid Istiqlal", slug: "masjid-istiqlal", description: "Masjid terbesar di Asia Tenggara.", categoryId: katReligi.id, difficultyLevel: "mudah", isActive: true, visitEstimateMinutes: 90 },
    { name: "Taman Mini Indonesia Indah", slug: "tmii", description: "Taman budaya dengan anjungan daerah dari seluruh Indonesia.", categoryId: katBudaya.id, difficultyLevel: "mudah", isActive: true, visitEstimateMinutes: 240, accessibilityInfo: "Tersedia kereta keliling, jalur khusus lansia" },
    { name: "Gunung Bromo", slug: "gunung-bromo", description: "Gunung berapi aktif dengan pemandangan matahari terbit yang spektakuler.", categoryId: katAlam.id, difficultyLevel: "sedang", isActive: true, visitEstimateMinutes: 300, accessibilityInfo: "Medan berbatu, butuh kendaraan 4x4, tidak disarankan bagi lansia dengan masalah jantung" },
    { name: "Pulau Komodo", slug: "pulau-komodo", description: "Taman Nasional Komodo, habitat asli komodo.", categoryId: katAlam.id, difficultyLevel: "sedang", isActive: true, visitEstimateMinutes: 360 },
    { name: "Danau Toba", slug: "danau-toba", description: "Danau vulkanik terbesar di Indonesia. Udara sejuk dan pemandangan memukau.", categoryId: katAlam.id, difficultyLevel: "mudah", isActive: true, visitEstimateMinutes: 200, accessibilityInfo: "Akses mobil sampai pinggir danau, area duduk tersedia" },
  ]).returning();
