    ...
    <form onSubmit={handleSubmit} className="max-w-3xl space-y-8">
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between border-b pb-2">
          ...
          <button type="button" onClick={addDestination} className="text-sm text-[#F49D1A] hover:text-[#c47d12] font-semibold inline-flex items-center gap-1">
          ...
          return (
            <div key={day} className="bg-slate-50 rounded-xl border border-slate-200 p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button type="button" onClick={() => addItineraryItem(day)} className="text-xs text-[#F49D1A] hover:text-[#c47d12] font-semibold inline-flex items-center gap-1">
